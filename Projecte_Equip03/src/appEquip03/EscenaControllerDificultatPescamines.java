...
public class EscenaControllerDificultatPescamines implements Initializable {
	@FXML
	...
	public void dificultad(ActionEvent e) throws IOException {
		...
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/appEquip03/EscenaPescamines.fxml"));
...
//    			ContextPescamines context = ContextPescamines.desserialitzacioTauler(f.getName());
//    			if(context == null)
